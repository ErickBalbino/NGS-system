...
>
          ...
          <img src={imageSrc} alt="proposta" />
            ...
            <p tw={`${customerName.length > 120 ? 'text-lg ' : customerName.length > 70 ? 'text-xl' : 'text-2xl'}  truncate`}>
              {customerName}
            </p>
          </div>
          ...
          <p tw={`${vehicles.length > 120 ? 'text-lg ' : vehicles.length > 70 ? 'text-xl' : 'text-2xl'}  truncate`}>
              {vehicles}
            </p>
          </div>

          <div tw="absolute top-[151] left-[26] flex overflow-hidden w-[150]">
